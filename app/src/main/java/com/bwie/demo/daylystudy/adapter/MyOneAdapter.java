...
public class MyOneAdapter extends BaseAdapter {
    Context context;
    List<ThreeSort.NodesBean.Nodes2Bean> list;

    public MyOneAdapter(Context context, List<ThreeSort.NodesBean.Nodes2Bean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tv_name.setText(list.get(position).getMenu3().getCategory_name());
        return convertView;
    }
    class ViewHolder{
        TextView tv_name;
